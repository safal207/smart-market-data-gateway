...
Describe the smallest reviewable transition in this pull request.

### Failure path

<!-- State the concrete erroneous, unsafe, or nondeterministic path this change prevents. -->

### Invariant after change

<!-- State the property that must hold after this exact base-to-head transition. -->

### Regression evidence

<!-- Name changed tests or exact existing repository test paths, for example tests/test_example.py. -->

### Residual risk

<!-- State what remains unproved, external, intentionally deferred, or outside scope. -->
