...
from benchmarks.resilience_load import parse_utc_timestamp, quote_was_received_after
...
def test_quote_without_received_at_fails_closed() -> None:
    ...
    assert quote_was_received_after({"provider_timestamp": "2099-01-01T00:00:00Z"}, cutoff) is False
